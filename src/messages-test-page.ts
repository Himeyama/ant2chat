...
<head>
  ...
  <title>llmglot — Messages API テスト</title>
  ...
  <main class="max-w-3xl mx-auto">
    ...
    <header class="mb-10 pb-6 border-b-2 border-px-bdr">
      <h1 class="text-2xl font-bold tracking-widest mb-3">
        <a href="/" class="text-px-txt no-underline hover:text-px-tea transition-colors"><span class="text-px-tea">▸</span> llmglot</a><span class="text-px-mut font-normal"> /v1/messages</span>
      </h1>
